...
class ScrapyGitcoinSpiderMiddleware:
...
class ScrapyGitcoinDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapyGitcoinBountiesDownloaderMiddleware:
    @classmethod
    def from_crawler(cls, crawler):
        s = cls()
        crawler.signals.connect(s.spider_opened, signal=signals.spider_opened)
...
class ScrapyGitcoinHttpProxyDownloaderMiddleware:
